const descriptions = {
        ...
        back: "<p>This has been my favorite so far. I began learning Node.js and MongoDB in an online bootcamp building out a fullstack production web application. Afterwards I continued improving my skills building bots and CRUD applications.</p><p>I am currently working on a few side projects such as an e-mail microservice and an API with an admin dashboard with CRUD capabilities.</p>",
